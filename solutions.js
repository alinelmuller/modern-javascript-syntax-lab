...
console.log(firstTopping); // 'Rover'
console.log(secondTopping); // 'Snuffles'
...
// Given the following object, use destructuring to create variables `make` and `model` that will hold 
...
// Your code here
const pizzaFlavour = 'tasty'
let flavour = pizzaFlavour === 'tasty' ? 'yum' : 'yuck';
...
const userSavedTheme = 'light'; // Change to 'dark', 'contrast', etc., or keep it null
...
// Now check for `cat.age` on `adventurer`. See how it errors out? Use optional chaining in a console.log
// that it returns undefined instead.
